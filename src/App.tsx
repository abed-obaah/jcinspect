...
export default function Example() {
  return (
    <div className="flex">
      ...
      <div className="flex flex-col justify-between w-full">
        <div className="flex items-center justify-between px-10">
          <div className="flex items-center">
            ...
            <h1 className="ml-2 text-[#757575]">WELCOME TO JCINSPECT</h1>
          </div>
          <div>
            <p className=" text-[#424242}">Already a member? <span className="font-bold text-[#212121] underline">LOG IN NOW</span></p>
          </div>
        </div>
          ...
          <MenuItem>
            ...
            />
                    <input
                      ...
                      required
                      className="block w-full py-5 pl-3 text-gray-900 placeholder:text-gray-400 border-0 sm:text-sm sm:leading-6"
                    />
      ...
      <button
        type="submit"
        className="flex items-center justify-between w-full rounded-md bg-[#24243E] px-3 py-5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
      >
        <span>Sign in</span>
