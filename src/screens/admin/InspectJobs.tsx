...
import Types from '../../components/adminComponents/Inspect'
...
<div className="mt-auto">
    ...
    <div className="px-4 sm:px-6 lg:px-8 flex justify-between">
        <h1 className="text-3xl">Inspect Jobs</h1>
    ...
    <div className="flex flex-wrap px-4 sm:px-6 lg:px-8">
        ...
        <button
                    type="button"
                    className="mt-88 mx-auto block rounded-full bg-[#0A6835] px-20 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-50 hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                    Go
                </button>
        </div>
